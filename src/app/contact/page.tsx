        ...
        <div className="container grid max-w-5xl gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="text-sm">
              ...
              <Button asChild className="mt-4 rounded-full">
                <a href={`mailto:${CHOIR.email}`}>{CHOIR.email}</a>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div className="font-medium text-foreground">{CHOIR.rehearsals.day}</div>
              <div className="text-muted-foreground">{CHOIR.rehearsals.time}</div>
              <div className="text-muted-foreground">
                {CHOIR.rehearsals.sundayWarmUp}
              </div>
