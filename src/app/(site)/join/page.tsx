...
function steps(rehearsals: ChoirContent["rehearsals"]) {
  return [
    {
      title: "Come to a rehearsal",
      body: `Drop in on a ${rehearsals.day.toLowerCase()} rehearsal between ${rehearsals.time}. No need to book — just arrive about 10 minutes early.`,
    },
    {
      title: "Sing with us",
    ...
    },
    {
      ...
      body: `Once you're settled, you'll join us for the ${CHOIR.ministersAt.label} warm-up at ${rehearsals.sundayWarmUp.toLowerCase()}.`,
    },
  ];
}
        ...
        <div className="container max-w-4xl py-6 sm:py-7">
          ...
          <div className="mt-4 flex flex-wrap gap-2.5">
            ...
            <Button asChild size="lg" variant="outline" className="rounded-full border-primary-foreground/30 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground">
              <a href={`mailto:${email}?subject=I'd%20like%20to%20join%20the%20choir`}>
          ...
          <Card className="border-secondary/30 bg-secondary/5">
            ...
            <CardContent className="space-y-2 pt-0 text-sm">
              ...
              <div className="flex items-start gap-2 text-foreground">
                ...
                <span>{rehearsals.sundayWarmUp}</span>
              </div>
